...
## 存在问题
### 1.抓取数量限制：
在v1.0.0版本时，抓取用户图片时，根据用户首页地址：

> （https://username.imgbb.com/）
来获取最新的1-32张图片中的任意图片，为什么会有数量限制？因为ImgBB 网站本身的反爬 / 动态加载特性，首页为page：1的内容。当用户进继续往下加载，网页链接变为：
> https://username.imgbb.com/page=2&seek=ajdGhA/
我暂时还没有想好怎么解决这个问题。
